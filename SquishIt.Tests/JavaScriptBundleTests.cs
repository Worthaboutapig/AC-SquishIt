...
//{
//	using Framework.Invalidation;
//	using Framework.Minifiers;

//	public abstract class JavaScriptBundleTests
//    {
...
//        /// </summary>
//        protected JavaScriptBundleTests(string baseOutputHref, IPathTranslator pathTranslator, IResourceResolver resourceResolver, IRenderer releaseRenderer, Func<bool> debugPredicate, ICacheInvalidationStrategy cacheInvalidationStrategy, IMinifier<JavaScriptBundle> javascriptMinifier, string hashKeyName, string virtualPathRoot)
//        {
...
//        public void Setup()
//        {
//            javaScriptBundleFactory = new JavaScriptBundleFactory(_baseOutputHref, _pathTranslator, _resourceResolver, _releaseRenderer, _debugPredicate, _cacheInvalidationStrategy, _javascriptMinifier, _hashKeyName, _virtualPathRoot)
...
//            var javaScriptBundleFactory = new JavaScriptBundleFactory(_baseOutputHref, _pathTranslator, resolver.Object, _releaseRenderer, _debugPredicate, _cacheInvalidationStrategy, _javascriptMinifier, _hashKeyName, _virtualPathRoot);
//            var tag = javaScriptBundleFactory
//                .WithDebuggingEnabled(false)
...
//            var tag = new JavaScriptBundleFactory(_baseOutputHref, _pathTranslator, StubResolver.ForDirectory(new[] {file1, file2}), _releaseRenderer, _debugPredicate, _cacheInvalidationStrategy, _javascriptMinifier, _hashKeyName, _virtualPathRoot)
//                .WithDebuggingEnabled(true)
//                .WithFileReaderFactory(frf)
//                .WithFileWriterFactory(writerFactory)
...
//            var tag = new JavaScriptBundleFactory(_baseOutputHref, _pathTranslator, StubResolver.ForDirectory(new[] {file1, file2}), _resourceResolver, _virtualPathRoot)
//                .WithDebuggingEnabled(false)
//                .WithFileReaderFactory(frf)
//                .WithFileWriterFactory(writerFactory)
//                .WithHasher(new StubHasher("hashy"))
...
//            var tag = new JavaScriptBundleFactory(_baseOutputHref, _pathTranslator, _resourceResolver, _releaseRenderer, _debugPredicate, _cacheInvalidationStrategy, _javascriptMinifier, _hashKeyName, _virtualPathRoot)
//                .WithDebuggingEnabled(true)
//                .Create()
...
//        {
//            ((HttpResolverStub) Configuration.Instance.HttpResolver).AddResolveFileResolution("http://localhost/", "B:\\");
...
//            Func<bool> queryStringPredicate = () => httpContext.Request.QueryString.AllKeys.Contains("debug") && httpContext.Request.QueryString["debug"] == "true";
...
//            httpContext = nonDebugContext.Object;
...
//            debugContext.Setup(hcb => hcb.Request.QueryString).Returns(new NameValueCollection
//                                                                       {
//                                                                           {"debug", "true"}
//                                                                       });
...
//            httpContext = debugContext.Object;
//            tag = bundle.Render("~/output.js");

//            expectedTag = "<script type=\"text/javascript\" src=\"test.js\"></script>\n<script type=\"text/javascript\" src=\"anothertest.js\"></script>\n";
...
//            expectedTag = "<script type=\"text/javascript\" src=\"output.js?r=hash\"></script>";
